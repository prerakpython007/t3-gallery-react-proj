...
export async function Images() {
  ...
  return (
    <div className="h-screen bg-[#1d0938]">
      <div className="mt-16 grid grid-cols-2 gap-8 p-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
        {images.map((image) => (
          <div
            key={image.id}
            className="group w-full overflow-hidden rounded-lg bg-white/5 backdrop-blur-sm transition-all duration-300 hover:bg-white/10"
          >
            {/* 
            ...
            <div className="relative aspect-square">
              {/* <Link href={`/img/${image.id}`}> */}
                ...
                <Image
                  ...
                  className="h-full cursor-pointer w-full object-cover transition-transform duration-500 group-hover:scale-105"
                />
                
              {/* </Link> */}
              
            </div>
            <div className="border-t border-[#AF47D2]/10 p-3">
...
export default async function HomePage() {
  return (
    <main className="relative min-h-screen bg-gradient-to-b from-purple-950 via-purple-900 to-purple-950">
